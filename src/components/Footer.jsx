export default function Footer() {
  return (
    <div className="h-20 md:h-22 w-full bg-sky-200 flex justify-center items-center border-t-2 border-black">
  ...
  <a href="https://www.linkedin.com/in/ozielguerra/" target="_blank" className="m-6 md:m-8 text-primary"><FaLinkedinIn className="w-auto h-9" /></a>*/}
      <p className=" text-slate-800 font-bold"> Mazatlan 2503 </p>
    </div>
  );
}
